...
@interface WorldGameViewController ()
...
//菜单中tableView的控制类
@property (nonatomic,strong)WorldGameTableViewController *gameMenuTVC;
...
@implementation WorldGameViewController
...
- (void)viewDidLoad {
    ...
    //初始化菜单控制类
    self.gameMenuTVC = [[WorldGameTableViewController alloc] init];
