//
//  NormalGameMenuTableViewController.m
//  RussianCube
//
...
@interface NormalGameMenuTableViewController () <UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong)NSArray *menu;
@property (nonatomic,strong)NSArray *menuImage;
@end

@implementation NormalGameMenuTableViewController
...
- (NormalGameMenuTableViewController *)init {
    self = [super init];
    if (self != nil) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString * cellIndetifier = @"normalGameMenuCell";
