//
//  GameMenuTableViewController.m
//  RussianCube
//
//  Created by andy.yao on 12/7/15.
...
@interface GameMenuTableViewController () <UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong)NSArray *menu;
@property (nonatomic,strong)NSArray *menuImage;
@end

@implementation GameMenuTableViewController
...
- (GameMenuTableViewController *)init {
    self = [super init];
    if (self != nil) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString * cellIndetifier = @"gameMenuCell";
